...
class Gateway {
  ...
  constructor(contractRegistry) {
    ...
    this.token = contractRegistry.mockToken;
    this.baseToken = contractRegistry.baseToken;
    this.gateway = contractRegistry.gateway;
    this.deployer = contractRegistry.owner;
